...
1. Write the JSON schema describing your resource, `brianterry-unicorn-maker.json`
2. Implement your resource handlers in `brianterry_unicorn_maker/handlers.py`
